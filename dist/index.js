...
var Chooser = /** @class */ (function () {
     ...
     */
    Chooser.chooseWeightedIndex = function (weights, seed, defaultWeight) {
     ...
     * @returns The chosen object, or `null` if the array was empty or all weights were `0`.
     */
    Chooser.chooseWeightedObject = function (arrayOfObjects, weightPropertyKey, defaultWeight, seed) {
        ...
        var chosenIndex = Chooser.chooseWeightedIndex(weights, seed, defaultWeight);
