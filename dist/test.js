...
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, Math.random()));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, Math.random()));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, Math.random()));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, Math.random()));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, Math.random()));
...
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, seed));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, seed));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, seed));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, seed));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "rating", 2.5, seed));
...
console.log(Chooser.chooseWeightedObject(restaurantRatings, "blah blah missing property"));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "blah blah missing property"));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "blah blah missing property"));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "blah blah missing property"));
console.log(Chooser.chooseWeightedObject(restaurantRatings, "blah blah missing property"));
...
console.log(Chooser.chooseWeightedObject(lottery, "weight", 1, "RaNdom-Seed-WeiGHted-Chooser"));
